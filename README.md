<div align="center">
  <img src="IMG_1845.JPG" width="100" height="150"/>
</div>
<h3 align="center">A Passionate Problem-Solver | IT Service Specialist</h3>

# Hi 👋, I'm Sandra

## :unicorn: Summary
With over 13 years of experience in IT Service Delivery, I specialize in optimizing operational efficiency in complex environments through process development and technical innovation. I excel in complex analysis, pattern recognition, and anomaly detection to troubleshoot challenging issues, always with the goal of maximizing business value through improved IT service delivery.

My unique strength lies in combining deep expertise in ITIL processes and agile methodologies with hands‑on programming skills (Python, SQL, API development). I build custom visualization and analysis tools to transform raw data into data‑driven decision support and to optimize processes. I have a proven ability to lead teams, drive Lean Six Sigma initiatives, and manage modern client environments such as SCCM, Intune, and Citrix.
...
* **Virtualization & Client**: VMware, Citrix, Windows Server, macOS, Jamf, Apple Configurator.
* **Networking & Security**: TCP/IP, DNS, DHCP, VPN, IT security (Defense against the dark arts).


**Automation, Programming & Data Analysis**  
* **Programming & Scripting**: Python (Flask, Dash, API development), PowerShell, Bash/Shell scripting, SQL, R, VBA.
* **Data Analysis & BI**: Power BI, Snowflake, IBM Cognos, IBM Watson, Tableau, Advanced Excel.
* **AI & ML**: Foundational Machine Learning (ML), NLP, and Deep Learning. Utilizes Generative AI for predictive analytics.
* **Data Formats**: JSON, YAML, XML, HTML.


**Methodology, Process & Strategic Leadership**  
* **Process Optimization**: Lean Six Sigma Green Belt (100+ tools), Root Cause Analysis, KPI management.
* **Frameworks**: ITIL (expertise in incident/problem/change), Agile, Scrum, Project Management (Google Certified).
* **Strategic Leadership**: Expert at bridging the gap between technology and business. Experience in cross‑functional leadership, employee development (1:1), and knowledge management (KCS).
...
* **Interpersonal Leadership & EQ**: Strong emotional intelligence (EQ) and user‑focused leadership.
...
<p align="left">
<a href="https://github.com/SnowY4you" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/github.svg" alt="SnowY4you" height="30" width="40" /></a>
<a href="https://dev.to/SnowY4you" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/devto.svg" alt="SnowY4you" height="30" width="40" /></a>
<a href="https://linkedin.com/in/sandravanbuggenum" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg" alt="sandravanbuggenum" height="30" width="40" /></a>
</p>
